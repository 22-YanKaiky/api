      													...
      													<table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation"
      														...
      														<tr>
      															<td
      																...
      																<div align="center" style="line-height:10px"><img alt="Cinemovie"
      													...
      													<table border="0" cellpadding="0" cellspacing="0" class="heading_block" role="presentation"
      														...
      														<tr>
      															<td style="text-align:center;width:100%;padding-top:35px;">
      																<h1
      																	style="margin: 0; color: #FF0000; direction: ltr; font-size: 50px; font-weight: normal; letter-spacing: 1px; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; font-family: 'Ubuntu';">
      															...
      															<td style="padding-bottom:40px;padding-left:15px;padding-right:15px;padding-top:40px;">
      																<div>
      																	<div class="txtTinyMce-wrapper" style="color: #d2cbcb; line-height: 1.5;">
      																		<p style="margin: 0; font-size: 20px; text-align: start; font-family: 'Poppins'; font-weight: 500;">
      																...
      																<table align="center" border="0" cellpadding="0" cellspacing="0" class="social-table"
      																	...
      																	<tr>
      																		<td style="padding:0 5px 0 5px;"><a
      																				href="https://www.facebook.com/yankaikyaugusto.dossantos" target="_blank"><img
      																					alt="Facebook" height="32" src="./images/facebook2x.png"
      																					style="display: block; height: auto; border: 0;" title="Facebook"
      																					width="32" /></a></td>
      																		<td style="padding:0 5px 0 5px;"><a href="https://twitter.com/" target="_blank"><img
      																					alt="Twitter" height="32" src="./images/twitter2x.png"
      																					style="display: block; height: auto; border: 0;" title="Twitter"
      																					width="32" /></a></td>
      																		<td style="padding:0 5px 0 5px;"><a href="https://www.instagram.com/yank.a.s.12/"
      																				target="_blank"><img alt="Instagram" height="32" src="./images/instagram2x.png"
      																					...
      																					width="32" /></a></td>
      																		<td style="padding:0 5px 0 5px;"><a href="https://www.youtube.com/"
      																				target="_blank"><img alt="YouTube" height="32" src="./images/youtube2x.png"
      																					style="display: block; height: auto; border: 0;" title="YouTube"
      																					width="32" /></a></td>
      																	</tr>
      																</table>
      															</td>
      											...
      											<tr>
      												<td class="column column-1"
      													...
      													<table border="0" cellpadding="10" cellspacing="0" class="text_block" role="presentation"
															...
															<td>
																<div>
																	<div class="txtTinyMce-wrapper" style="color: #fff; line-height: 1.2;">
																		<p style="margin: 0; text-align: center;">© Copyright 2022. Cinemovie All Rights
																			Reserved.</p>
																		<p style="margin: 0; text-align: center;"><a href="http://www.example.com/"
																				rel="noopener" style="color: #0055ff;" target="_blank"
																				title="http://www.example.com">Manage Preferences</a> | <a
																				href="http://www.example.com/" rel="noopener" style="color: #0055ff;"
																				target="_blank" title="http://www.example.com">Unsubscribe</a></p>
																		<p style="margin: 0; font-size: 12px; text-align: center;"><span
																				style="color:#c0c0c0;"> </span></p>
																	</div>
																</div>
															</td>
														</tr>
